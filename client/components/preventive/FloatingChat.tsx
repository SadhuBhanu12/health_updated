...
export default function FloatingChat() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      {open && (
        <div className="mb-3 w-[360px] max-w-[90vw] h-[520px] rounded-xl border bg-white shadow-2xl overflow-hidden">
          ...
          <div className="h-[calc(520px-40px)] overflow-auto p-2 bg-gradient-to-br from-emerald-50 via-white to-teal-50">
